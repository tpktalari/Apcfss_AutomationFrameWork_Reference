	...
	public void waitPage() {
		...
		try {
			...
			if (element.isDisplayed()) {
				new WebDriverWait(DriverManager.getDriver(), Duration.ofSeconds(35))
...
//	@Description("Testcase Description: Velifying whether logo is dispalyed")
//	@Story("Story Name: To check logo")
	...
	public void ClickOnServiceInputBox() {
		new WebDriverWait(DriverManager.getDriver(), Duration.ofSeconds(25))
	...
	@FrameworkAnnotations(author = { "Sravankumar" }, category = { CategoryType.SMOKE })
	...
	@FrameworkAnnotations(author = { "Vishnu" }, category = { CategoryType.SMOKE })
	...
	public void EnterDataAndClickProceedClickSubmitWithEpayClickSbi() {
		...
		Reporter.log("Submit Button is Clicked successfully with E Payment Mode radio button and navigated to sbi mops page",true);
	}
	...
	public void EnterDataAndClickProceedClickSubmitWithEpayClickPayU() {
		...
		try {
			...
			} catch (NoSuchElementException i) { // Error message not found, continue with execution }
		...
		new WebDriverWait(DriverManager.getDriver(), Duration.ofSeconds(10))
				.until(ExpectedConditions.urlContains("payu"));
		System.out.println("*************");
